<?php 
//registroDeDepartamentos.php para el registro de departamentos como admin
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top"> 
                <ul class="navbar-nav"> 
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0"> 
                        ...
                        <h3 class="welcome-sub-text">MOTORES REYNOSA | Crea y desarrolla nuevos departamentos</h3> 
                    </li> 
                </ul> 
