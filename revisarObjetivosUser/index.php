<?php 
require_once( '../php/check_auth.php'); session_start(); 
...
$user_id = $_SESSION[ 'user_id']; ?>
  ...
  <html lang="en">  
    ...
    <body>
            ...
            <ul class="navbar-nav ms-auto">
              <li class="nav-item">
                <form class="search-form" action="#" id="search-form">
                  ...
                  <input type="search" class="form-control" placeholder="Buscar objetivos..."
                  title="Search here" class="form-control" id="searchInput">
                </form>
              </li>
                      ...
                      <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                          ...
                          <p class="card-subtitle card-subtitle-dash">
                            Revisa y gestiona tus objetivos personales
                          </p>
                        </div>
                        <div>
                          <a href="../nuevoObjetivoUser">
      ...
      <script src="../js/custom_dialog.js">
      </script>
      ...
      <script src="../js/user_manage_objectives.js"></script>
