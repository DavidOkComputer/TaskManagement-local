   ...
   ?>
	...
	<html lang="en">
		...
		<body>
								...
								<div class="dropdown-menu dropdown-menu-right navbar-dropdown notification-dropdown pb-0"
									...
									<div class="dropdown-header d-flex justify-content-between align-items-center py-3 border-bottom">
										...
										<a href="javascript:void(0)" id="markAllNotificationsRead" class="text-primary small">
											<i class="mdi mdi-check-all me-1">
											</i>
								...
								<div class="card">
									<div class="card-body">
										<div id="alertContainer">
											<h4 class="card-title">
												Asignación de tareas para proyectos
											</h4>
											...
											<div class="col-bg-12">
												<div class="form-group row">
													...
													<div class="col-sm-9">
														...
														<small class="form-text text-muted" id="projectPermissionNote" style="display: none;">
														</small>
													</div>
													<hr>
												</div>
												...
												<div class="list-wrapper">
													<ul class="todo-list todo-list-rounded" id="tasksList">
														<li class="d-block text-center py-4">
															<p class="text-muted">
																Seleccione un proyecto para ver sus tareas
															</p>
														</li>
													</ul>
												</div>
			...
			<!--mandar los datos de la sesion a js-->
			<script>
				window.APP_CONFIG = {
