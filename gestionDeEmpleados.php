              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Ingrese la informacion de su nuevo proyecto
                  </p>
                  <form class="forms-sample">
                    <div class="form-group row">
                      <label for="nombreDeProyecto" class="col-sm-3 col-form-label">Nombre</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="nombreDeProyecto" placeholder="Ingrese el nombre">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="descripcionDeProyecto" class="col-sm-3 col-form-label">Descripcion</label>
                      <div class="col-sm-9">
                        <input type="email" class="form-control" id="descripcionDeProyecto" placeholder="Ingrese la descripcion">
                      </div>
                    </div>
                    <div class="form-group row">
