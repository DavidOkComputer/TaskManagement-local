...
<body>
              ...
              <div class="home-tab">
                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                  <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active ps-0" id="profile-tab" href="../proyectosTotalesGerente" role="tab" aria-selected="true">Proyectos totales</a>
                    </li>
                    <li class="nav-item">
  ...
  <script src="../js/manager_list_total_projects.js"></script>
