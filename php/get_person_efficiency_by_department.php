...
try {
    ...
    // Query para obtener eficiencia de personas en este departamento
    // X-axis: Total de tareas asignadas
...
function processPersonEfficiencyData($efficiency_data) {
    ...
    foreach ($efficiency_data as $index => $person) {
        $scatterPoints[] = [
            'x' => $person['total_tareas'],           // X-axis: Total de tareas (carga de trabajo)
            'y' => $person['tasa_completacion'],      // Y-axis: % completado (eficiencia)
            'r' => max(7, min(13, $person['total_tareas'] / 2)), // Tamaño proporcional a carga
...
function getPersonEfficiencyColors($count) {
    $colors = [
        // Verdes en gradiente
        ['border' => 'rgba(34, 139, 89, 1)', 'background' => 'rgba(34, 139, 89, 0.65)'],
        ['border' => 'rgba(80, 154, 108, 1)', 'background' => 'rgba(80, 154, 108, 0.65)'],
        ['border' => 'rgba(24, 97, 62, 1)', 'background' => 'rgba(24, 97, 62, 0.65)'],
        ['border' => 'rgba(45, 110, 80, 1)', 'background' => 'rgba(45, 110, 80, 0.65)'],
        // Grises en gradiente
        ['border' => 'rgba(130, 140, 150, 1)', 'background' => 'rgba(130, 140, 150, 0.65)'],
        ['border' => 'rgba(160, 170, 180, 1)', 'background' => 'rgba(160, 170, 180, 0.65)'],
        ['border' => 'rgba(200, 205, 210, 1)', 'background' => 'rgba(200, 205, 210, 0.65)'],
        ['border' => 'rgba(50, 50, 50, 1)', 'background' => 'rgba(50, 50, 50, 0.65)'],
        // Repetir si hay más personas
        ['border' => 'rgba(34, 139, 89, 0.8)', 'background' => 'rgba(34, 139, 89, 0.5)'],
        ['border' => 'rgba(80, 154, 108, 0.8)', 'background' => 'rgba(80, 154, 108, 0.5)'],
        ['border' => 'rgba(24, 97, 62, 0.8)', 'background' => 'rgba(24, 97, 62, 0.5)'],
        ['border' => 'rgba(45, 110, 80, 0.8)', 'background' => 'rgba(45, 110, 80, 0.5)'],
    ];

    // Ciclar si hay más personas que colores
    $result = [];
    for ($i = 0; $i < $count; $i++) {
