...
try {
    ...
    if ($passwordCheck['valid']) {
        ...
        //destruir cualquier sesion previa al timeout o logout
        ...
        //iniciar una sesion nueva con un nuevo id y cocokies
        session_start();
        session_regenerate_id(true);

        //poblar la info de la sesion
        ...
        // Información de roles múltiples
        ...
        //forzar escribir la sesion en disco antes de enviar el json de respuesta
        session_write_close();
