...
/* manager_api_get_overdue_projecst.php para proyectos vencidos filtrados por departamento */ 
...
try { 
    // Obtener todos los proyectos vencidos del departamento 
    $query = " 
        SELECT DISTINCT 
            p.id_proyecto, 
            p.nombre, 
