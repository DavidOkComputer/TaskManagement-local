<?php
// create_user.php para crear usuarios CON SOPORTE DE FOTO DE PERFIL
...
try {
    ...
    // Insertar usuario primero para obtener el ID
    $stmt = $conn->prepare("
        INSERT INTO tbl_usuarios 
        (nombre, apellido, usuario, num_empleado, acceso, id_departamento, id_rol, id_superior, e_mail, foto_perfil) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    ");
