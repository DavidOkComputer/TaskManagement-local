<?php 
/*Vista de Gantt para tareas de proyectos - Vista de Gerente */
...
<html lang="es">
	<head>
		...
		<title>Diagrama de Gantt - Proyectos de mi Departamento</title>
		<!-- plugins:css -->
				...
				<div class="navbar-menu-wrapper d-flex align-items-top">
					<ul class="navbar-nav">
						<li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
							...
							<h3 class="welcome-sub-text">MOTORES REYNOSA | Visualiza el progreso de las tareas de tu departamento en el diagrama de Gantt</h3>
						</li>
					</ul>
									...
									<div class="card-body p-3 d-flex flex-column" style="overflow: hidden;">
										<div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-2">
											<div class="d-flex align-items-center">
												<h4 class="card-title mb-0 me-3">
													<i class="mdi mdi-chart-gantt me-1"></i>Diagrama de Gantt <small class="text-muted fs-6 ms-2">(Mi Departamento)</small>
												</h4>
											</div>
										...
										<div id="projectInfoSummary" class="mb-2" style="display: none;">
											<div class="alert alert-info py-1 px-3 mb-0 small">
												<div class="d-flex flex-wrap justify-content-start align-items-center gap-4">
													...
													<span id="summaryDepartment" class="text-primary">
														<i class="mdi mdi-domain me-1"></i>
														<span id="summaryDeptName">-</span>
													</span>
												</div>
											</div>
										</div>
										<div class="flex-grow-1 position-relative" style="min-height: 0; overflow: hidden;">
											...
											<div id="ganttDefaultMessage" class="text-center py-4">
												...
												<p class="mt-2 text-muted mb-0">Seleccione un proyecto de su departamento para visualizar el diagrama de Gantt</p>
											</div>
											...
											<div id="ganttNoProjects" class="text-center py-4" style="display: none;">
												...
												<p class="mt-2 text-muted mb-0">No hay proyectos disponibles en su departamento</p>
											</div>
