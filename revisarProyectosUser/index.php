...
$user_id = $_SESSION[ 'user_id']; ?>
  ...
  <html lang="es">
    ...
    <head>
      ...
      />
      <style>
        .action-buttons { display: flex; gap: 5px; flex-wrap: wrap; align-items:
        center; } .btn-action { padding: 5px 10px; font-size: 14px; } .empty-state
        { padding: 40px 20px; } .pagination-container { display: flex; justify-content:
        space-between; align-items: center; flex-wrap: wrap; gap: 15px; } .pagination-info
        { color: #666; } .pagination-buttons { display: flex; gap: 10px; align-items:
        center; } .page-buttons { display: flex; gap: 5px; } .pagination-ellipsis
        { padding: 0 10px; color: #999; } .sortable-header { transition: all 0.2s
            ...
            <ul class="nav">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="form-elements">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="../nuevoProyectoUser/">
                        Crear nuevo proyecto
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="../nuevoObjetivoUser/">
                        Crear nuevo objetivo
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="../nuevoTareaUser/">
                        Crear nueva tarea
                      </a>
                    </li>
                  </ul>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="charts">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="../revisarGraficosUser">
                        Revisar graficos
                      </a>
                    </li>
                    <li class="nav-item"> 
                      <a class="nav-link" href="../graficaGanttUser">
                        Gráfica de Gantt
                      </a>
                    </li>
                  </ul>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="tables">
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="../revisarProyectosUser/">
                        Revisar proyectos
                      </a>
                    </li>
                  </ul>
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="../revisarObjetivosUser/">
                        Revisar objetivos
                      </a>
                    </li>
                  </ul>
                  <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="../revisarTareasUser/">
                        Revisar tareas
                      </a>
                    </li>
                  </ul>
                      ...
                      <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                          ...
                          <p class="card-subtitle card-subtitle-dash">
                            Solo puedes ver y gestionar proyectos donde eres creador o participante
                          </p>
                          <div class="alert alert-info mt-3" role="alert">
                            <i class="mdi mdi-information me-2">
                            </i>
                            <strong>
                              Permisos:
                            </strong>
                            Solo puedes editar y eliminar proyectos que hayas creado. Los demás proyectos
                            son de solo lectura.
                          </div>
                        </div>
                        <div>
