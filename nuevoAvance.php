...
<head>
  ...
  <title>Administrador de avances </title>
  <!-- plugins:css -->
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            ...
            <h3 class="welcome-sub-text">Crea y desarrolla nuevos avances </h3>
          </li>
        </ul>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Crear nuevo avance</h4>
                  <p class="card-description">
                    Ingresa la informacion de tu nuevo avance
                  </p>
                  <form class="forms-sample">
                    <div class="form-group row">
                      <label for="nombreDeAvance" class="col-sm-3 col-form-label">Nombre</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="nombreDeAvance" placeholder="Ingrese el nombre">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="descripcionDeAvance" class="col-sm-3 col-form-label">Descripcion</label>
                      <div class="col-sm-9">
                        <input type="email" class="form-control" id="descripcionDeAvance" placeholder="Ingrese la descripcion">
                      </div>
                    </div>
                    <div class="form-group row">
