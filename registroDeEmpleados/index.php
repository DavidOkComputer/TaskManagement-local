            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-check form-switch mb-3">
                        ...
                        <label class="form-check-label" for="modalToggleEsSupervisor">
                            <i class="mdi mdi-account-tie"></i>
                            <strong>Es supervisor</strong>
                            <small class="text-muted d-block">Mostrar solo supervisores en lugar de gerentes</small>
                        </label>
                    </div>
