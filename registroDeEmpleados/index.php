                    ...
                    <div class="col-12 grid-margin stretch-card"> 
                        ...
                        <div class="card card-rounded"> 
                            ...
                            <div class="card-body"> 
                                ...
                                <form id="formCrearUsuario" method="POST" action="php/procesar_usuario.php"> 
                                    ...
                                    <!-- Row 3: Número de Empleado y Rol --> 
                                    ...
                                    <div class="row"> 
                                        ...
                                        <div class="col-md-12"> 
                                            ...
                                            <div class="form-group"> 
                                                ...
                                                <a href="../gestionDeEmpleados" class="btn btn-secondary btn-lg"> 
