...
document.addEventListener('DOMContentLoaded', function() { 
    ...
    function updateAddButtonVisibility() { 
        ...
        if (isCreator) { 
            ...
            const isParticipant = currentProjectData.id_participante === currentUserId ||  
                                  currentProjectData.es_mi_proyecto; 
     ...
     * Obtiene la información del badge según el estado 
     ...
     * Adjunta los listeners a los elementos de tarea 
