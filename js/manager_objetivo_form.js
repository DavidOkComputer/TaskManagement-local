/**objetivo_form.js - Maneja creacion y edicion de objetivos de gerente */
...
document.addEventListener('DOMContentLoaded', function() { 
    ...
    if (cancelBtn) { 
        cancelBtn.addEventListener('click', function(e) { 
            e.preventDefault(); 
            showConfirm( '¿Estás seguro de que deseas cancelar?\n\nLos datos ingresados se perderán.', function() { 
...
function handleFormSubmit(e) {
    ...
    .then(data => { 
        if (data.success) { 
            const successMessage = editMode.isEditing ? '¡Objetivo actualizado exitosamente!' : '¡Objetivo creado exitosamente!';
